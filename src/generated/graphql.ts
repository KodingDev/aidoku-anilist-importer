...
export type GetSelfQuery = { __typename?: 'Query', Viewer?: { __typename?: 'User', id: number, name: string } | null };
...
export type GetMangaQuery = { __typename?: 'Query', MediaListCollection?: { __typename?: 'MediaListCollection', lists?: Array<{ __typename?: 'MediaListGroup', name?: string | null, status?: MediaListStatus | null, entries?: Array<{ __typename?: 'MediaList', progress?: number | null, progressVolumes?: number | null, status?: MediaListStatus | null, media?: { __typename?: 'Media', id: number, title?: { __typename?: 'MediaTitle', romaji?: string | null, english?: string | null, native?: string | null } | null } | null } | null> | null } | null> | null } | null };
...
export type SearchQuery = { __typename?: 'Query', Media?: { __typename?: 'Media', id: number, title?: { __typename?: 'MediaTitle', romaji?: string | null, english?: string | null, native?: string | null } | null } | null };

export type SetMangaProgressMutationVariables = Exact<{
  id: Scalars['Int'];
  progress: Scalars['Int'];
  progressVolumes: Scalars['Int'];
  status?: InputMaybe<MediaListStatus>;
}>;


export type SetMangaProgressMutation = { __typename?: 'Mutation', SaveMediaListEntry?: { __typename?: 'MediaList', id: number, progress?: number | null, progressVolumes?: number | null, status?: MediaListStatus | null } | null };
...
export const SearchDocument = gql`
  ...
  Media(search: $query, type: MANGA) {
    ...
    `;
export const SetMangaProgressDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getSelf(variables?: GetSelfQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetSelfQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSelfQuery>(GetSelfDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getSelf', 'query');
    },
    getManga(variables: GetMangaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetMangaQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMangaQuery>(GetMangaDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getManga', 'query');
    },
    ...
    setMangaProgress(variables: SetMangaProgressMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SetMangaProgressMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetMangaProgressMutation>(SetMangaProgressDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'setMangaProgress', 'mutation');
    }
  };
}
